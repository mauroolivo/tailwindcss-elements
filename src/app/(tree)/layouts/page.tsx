    ...
    <>
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1">
          <div className="striped-bg col-start-1 row-start-1 rounded-lg border text-black/10 dark:text-white/12.5"></div>
        ...
        <div className="striped-bg flex flex-col gap-1 rounded-lg border px-4 font-mono text-sm leading-6 font-bold text-black/10 md:flex-row md:gap-6 dark:text-white/12.5">
        ...
        <div className="grid grid-cols-4 gap-4 rounded-lg text-center font-mono text-sm leading-6 font-bold text-white">
          ...
          <div className="col-span-3 grid grid-cols-subgrid gap-4">
            <div className="bg-size[:]8px_8px] striped-bg rounded-lg border p-4 text-black/10 dark:text-white/12.5"></div>
